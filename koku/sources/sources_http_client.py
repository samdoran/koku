...
class SourcesHTTPClient:
    ...
    def get_data_source(self, source_type, app_type_id):
        ...
        application_url = f"{self._base_url}/{ENDPOINT_APPLICATIONS}?filter[source_id]={self._source_id}&filter[application_type_id]={app_type_id}"
    ...
    def _get_aws_credentials(self, _):
        ...
        authentications_url = f"{self._base_url}/{ENDPOINT_AUTHENTICATIONS}?filter[source_id]={self._source_id}&filter[authtype]={auth_type}"
    ...
    def _get_azure_credentials(self, app_type_id):
        ...
        url = f"{self._base_url}/{ENDPOINT_APPLICATIONS}?filter[source_id]={self._source_id}&filter[application_type_id]={app_type_id}"
